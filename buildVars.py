...
addon_info = AddonInfo(
	...
	addon_changelog=_('* Tested with NVDA 2026.2.'),
	# Author(s)
	addon_author='Noelia Ruiz Martínez <nrm1977@gmail.com>',
	# URL for the add-on documentation support
	addon_url='https://github.com/nvdaes/reportSymbols',
	# URL for the add-on repository where the source code can be found
	addon_sourceURL='https://github.com/nvdaes/reportSymbols',
...
pythonSources: list[str] = ['addon/*.py', 'addon/globalPlugins/*.py']
